...
<form class="form-horizontal" role="form"  onsubmit="return submitForm(this);" action="towCodeResult/save" >
	...
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right tooltip-error" for="form-field-1"> twoText： </label>
		<div class="col-sm-9">
			<input type="text" id="twoText" name="twoText" placeholder="" class="col-xs-10 col-sm-7"/>
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right tooltip-error" for="form-field-1"> twoId： </label>
		<div class="col-sm-9">
			<input type="text" id="twoId" name="twoId" placeholder="" class="col-xs-10 col-sm-7"/>
		</div>
	</div>
