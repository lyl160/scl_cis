...
<%@ include file="/common/head.jsp" %>
	...
	<div class="form-actions align-right  form-button-box" style="margin-top: 0px">
		<button class="btn btn-info" type="button"  onclick="addButton(this);">
...
<script type="text/javascript">
	...
	jQuery(function($) {	
		...
		var p = dialog.getById('dlg-buttonadd');
		jQuery(dialog_grid_selector).jqGrid({
			url: "auth/buttonAdd/init.do?menuId="+p.dataParam.menuId+"&sysId="+p.dataParam.sysId,
			datatype: "json",
			height: "100%",
			width:'100%',
		 	colNames:[  '所属系统','上级菜单','菜单名称','菜单路径'],
			colModel:[
				{name:'sysId',    index:'sysId',     width:'100px',ditcKey:'SYSTYPE', formatter : gridFormatByDict},
				{name:'rmk',        index:'rmk',     width:'100px'},
				{name:'menuName',   index:'menuName',   width:'190px', formatter : menuNameFormat},
