...
<script type="text/javascript">
    ...
    //查询二级分类
    $.ajax({
        url: "inspectionTemplate/queryUser",
        type: "get",
        async: false,
        success: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                if (i < data.length - 1) {
                    classify += data[i].id + ":" + data[i].userName + ";";
                } else {
                    classify += data[i].id + ":" + data[i].userName;
                }
            }
    ...
    jQuery(function ($) {
            ...
            jQuery(dialog_grid_selector).jqGrid({
                ...
                cellEdit: true,
                cellsubmit: "remote",
                cellurl: "dynamicAttr/saveOrUpdate",
                jsonReader: {
                    root: "rows",
                    page: "page",
                    total: "totalPage",
                ...
                colNames: ['属性名称', '属性类别', '属性值', '评分标准', '人员', '操作'],
                colModel: [{
                    name: 'name',
                    index: 'NAME',
                    width: '5%',
    ...
    function saveRow() {
        ...
        for (var i = 0; i < count.length; i++) {
            ...
            if (i >= count1) {
                ...
                jsonMenu["uids"] = count[i].uidsShow;
