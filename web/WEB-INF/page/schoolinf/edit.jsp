...
<form class="form-horizontal" role="form"  onsubmit="return submitForm(this);" action="schoolInf/save1" >
	...
	<div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" id="schoolBm" name="schoolBm" placeholder="" validate="true" lass="col-xs-10 col-sm-10" value="${entity.schoolBm}"/> 
        </div>
        <label class="col-sm-2 control-label no-padding-right" for="form-field-2">  学校名称： </label>
        <div class="col-sm-3">
            <input type="text" id="schoolName" name="schoolName" placeholder="" class="col-xs-10 col-sm-10" value="${entity.schoolName}"/> 
        </div>
    </div>
	<div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">  校长： </label>
        <div class="col-sm-3">
            <input type="text" id="president" name="president" placeholder="" class="col-xs-10 col-sm-10" value="${entity.president}"/> 
        </div>
        <label class="col-sm-2 control-label no-padding-right" for="form-field-2">  学校国际名称： </label>
        <div class="col-sm-3">
            <input type="text" id="iname" name="iname" placeholder="" class="col-xs-10 col-sm-10" value="${entity.iname}"/> 
        </div>
    </div>
	<div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">  学校简称： </label>
        <div class="col-sm-3">
            <input type="text" id="sname" name="sname" placeholder="" class="col-xs-10 col-sm-10" value="${entity.sname}"/> 
        </div>
        <label class="col-sm-2 control-label no-padding-right" for="form-field-2">  联系人名称： </label>
        <div class="col-sm-3">
            <input type="text" id="contactsName" name="contactsName" placeholder="" class="col-xs-10 col-sm-10" value="${entity.contactsName}"/> 
        </div>
    </div>
	<div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">  联系人手机号： </label>
        <div class="col-sm-3">
            <input type="text" id="contactsMobile" name="contactsMobile" placeholder="" class="col-xs-10 col-sm-10" value="${entity.contactsMobile}"/> 
        </div>
        <label class="col-sm-2 control-label no-padding-right" for="form-field-2">  邮箱： </label>
        <div class="col-sm-3">
            <input type="text" id="email" name="email" placeholder="" class="col-xs-10 col-sm-10" value="${entity.email}"/> 
        </div>
    </div>
	<div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">  固定电话： </label>
        <div class="col-sm-3">
            <input type="text" id="fixPhone" name="fixPhone" placeholder="" class="col-xs-10 col-sm-10" value="${entity.fixPhone}"/> 
        </div>
        <label class="col-sm-2 control-label no-padding-right" for="form-field-2">  省市区： </label>
        <div class="col-sm-3">
            <input type="text" id="mainAddress" name="mainAddress" placeholder="" class="col-xs-10 col-sm-10" value="${entity.mainAddress}"/> 
        </div>
    </div>
	<div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">  详细地址： </label>
        <div class="col-sm-9">
            <input type="text" id="detailAddress" name="detailAddress" placeholder="" class="col-xs-10 col-sm-10" value="${entity.detailAddress}"/> 
        </div>
    </div>
    <div class="form-group">
	...
	<div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" id="businessLicense" name="businessLicense" placeholder="" class="col-xs-10 col-sm-10" value="${entity.businessLicense}"/> 
        </div>
        <label class="col-sm-2 control-label no-padding-right" for="form-field-2">  校长身份证： </label>
        <div class="col-sm-3">
            <input type="text" id="idCard" name="idCard" placeholder="" class="col-xs-10 col-sm-10" value="${entity.idCard}"/> 
        </div>
    </div>
	<div class="form-group">
   ...
   <div class="form-group">
        ...
        <div class="col-sm-9">
            <textarea type="text"  id="readme" name="readme" placeholder="" class="col-xs-10 col-sm-10" rows="10">${entity.readme}</textarea> 
        </div>
    </div>
