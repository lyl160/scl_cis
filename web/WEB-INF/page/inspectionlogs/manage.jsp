        ...
        <div style="display: block;" class="widget-body ">
            <div class="widget-main">
                <div class="rowt">
                    <div class="col-sm-12">
                        <div>
                            <label class="label_search">巡查人:</label>
                            <input id="keyword" type="text" name="czy" placeholder="请输入巡查人">
                            ...
                            <input class="date-pic"  id="jsTime" type="text" name="jsTime" placeholder="请选择结束时间"
                                   AUTOCOMPLETE="off">
                            <input id="keyword" type="text" name="name" value="后勤巡查" style="display:none;">
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div style="margin-top: 10px">
            <span><a class="btn btn-small btn-add" onclick="studentBillExport();">导出后勤巡查数据</a></span>
...
<script type="text/javascript">
    ...
    jQuery(function ($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            postData: {name: "后勤巡查",ksTime:$("#ksTime").val(),jsTime:$("#jsTime").val()},
            colNames: ['id', '巡检类别','巡检人', '班级Id', '班级', '年级', '总得分', '提交时间', '操作'],
            colModel: [
                {name: 'id', index: 'id', width: '20%'},
                {name: 'value', index: 'value', width: '20%'},
                {name: 'czy', index: 'czy', width: '20%'},
                {name: 'clazzId', index: 'clazz_id', width: '20%'},
                {name: 'clazz', index: 'clazz', width: '20%'},
                {name: 'grade', index: 'grade', width: '20%'},
                {name: 'totalScore', index: 'totalScore', width: '20%'},
    ...
    function pledgeGoodsMx(id) {
        openDialog({
            dialogId: 'dlg-mx',
            title: '后勤巡查详情',
            pageUrl: 'inspectionLogs/detail?id=' + id + '&value=后勤巡查',
            width: '750px',
            height: '500px',
    ...
    function studentBillExport() {
        msg.confirm({
            title: '确认', position: 'center', msg: '您确定要导出后勤巡查数据吗？', call: function (ok) {
                if (ok) {
                    window.location.href = "inspectionLogs/msgExport4Hq?tpl=后勤巡查&"+$("form").serialize();
                }
            }
        });
    }
