...
<form class="form-horizontal" role="form"  onsubmit="return submitForm(this);" action="schedule/saveorupdate" >
	<br/>
	...
	<div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">  users： </label>
        <div class="col-sm-9">
            <input type="text" id="users" name="users" placeholder="" class="col-xs-10 col-sm-7" value="${entity.users}"/> 
        </div>
    </div>
	<div class="form-group">
	...
	<div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">  week： </label>
        <div class="col-sm-9">
            <input type="text" id="week" name="week" placeholder="" class="col-xs-10 col-sm-7" value="${entity.week}"/> 
        </div>
    </div>
	<div class="form-group">
