...
public class OperateImage {
     ...
     * @throws IOException
     */
    public void alphaWords2Image(String srcImagePath, float alpha, String font, int fontStyle, int fontSize, Color color, String inputWords, int x, int y, String imageFormat, String toPath) throws IOException {
     ...
     * @throws IOException
     */
    public void alphaImage2Image(String srcImagePath, String appendImagePath, float alpha, int x, int y, int width, int height, String imageFormat, String toPath) throws IOException {
        FileOutputStream fos = null;
        try {
            BufferedImage image = ImageIO.read(new File(srcImagePath));
            // 创建java2D对象
    ...
    public static void main(String[] args) throws Exception {
        ...
        //将一个图片和一段文字放到另外一个图片中
        String firstSrcImagePath = "c:/haoledi_coupon_blank.jpg";
        String additionImagePath = "c:/qrcode.png";

        imageObj.mergeBothImage(firstSrcImagePath, additionImagePath, 25, 15, "c:/a.jpg");
        ...
        * */
        ...
        imageObj.alphaWords2Image("c:/a.jpg", 1.0f, "宋体", Font.BOLD, 20, Color.BLACK, "2015-11-30", 310, 140, "jpg", "c:/at.jpg");

        /*
         * String srcPath = "D:/test/fileSource/004.jpg"; String toPath =
         * "D:/test/desk/+e004.jpg"; int x = 200; int y = 300; int width = 300; int
         * height = 200 ; String readImageFormat = "jpg"; String writeImageFormat =
         * "jpg"
         */;
        ...
        // imageObj.mergeBothImageLeftbottom(negativeImagePath, additionImagePath,
        // toPath);//合并到左下角
        // imageObj.mergeBothImageRightbottom(negativeImagePath, additionImagePath,
        // toPath);//合并到右下角
        // imageObj.mergeBothImageCenter(negativeImagePath, additionImagePath,
        // toPath);//合并到正中央
        // imageObj.mergeBothImageTopcenter(negativeImagePath, additionImagePath,
        // toPath);//合并到上边中央
        // imageObj.mergeBothImageBottomcenter(negativeImagePath, additionImagePath,
        // toPath);//合并到下边中央
        // imageObj.mergeBothImageLeftcenter(negativeImagePath, additionImagePath,
        // toPath);//合并到左边中央
        // imageObj.mergeBothImageRightcenter(negativeImagePath, additionImagePath,
        // toPath);//合并到右边中央
         ...
         * secondSrcImagePath = "D:/test/desk/004.jpg"; String imageFormat = "jpg";
         ...
         * secondSrcImagePath = "D:/test/desk/003-004-join.jpg"; String imageFormat
         * = "jpg"; String toPath = "D:/test/desk/all-join.jpg";
         ...
         * {20,100,160,270,500}; int[] yPoints = {30,150,172,295,615}; int nPoints =
         * 5; String toPath = "D:/test/desk/polygon-002.png";
         ...
         * String font = "宋体"; int fontStyle = Font.PLAIN; int fontSize = 32; Color
         * color = Color.RED; String inputWords =
         * "图片上设置水印文字 ---- 宋体 普通字体 32号字 红色 透明度0.5"; int x = 20; int y = 40; String
         * imageFormat = "jpg"; String toPath = "D:/test/desk/alphaI2I-001.png";
         */
        // imageObj.alphaWords2Image(srcImagePath, alpha, font, fontStyle, fontSize,
        // color, inputWords, x, y, imageFormat, toPath); //设置文字水印
         ...
         * {100,150,200,240,300}; int[] yPoints = {200,60,280,160,100}; int nPoints
         * = 5; Color lineColor = Color.RED; String toPath =
        ...
        /*
         * int x1 = 50; int y1 = 100; int x2 = 600; int y2 = 150; Color lineColor =
         * Color.BLUE; imageObj.drawLine(srcImagePath, x1, y1, x2, y2,
         * lineColor,toPath, imageFormat);//画线段
         */

        /*
         * String srcImagePath = "D:/test/fileSource/002.jpg"; int x = 400; int y =
         * 500; int width = 10; int height = 10; Color ovalColor = Color.RED; String
         * imageFormat = "jpg"; String toPath = "D:/test/desk/point-002.jpg";
         * imageObj.drawPoint(srcImagePath, x, y, width, height, ovalColor,
         * imageFormat, toPath);//画一个圆点
         */

        /*
         * List pointList = new ArrayList(); Point p1 = new Point(60,80);
         * pointList.add(p1); Point p2 = new Point(160,80); pointList.add(p2); Point
         * p3 = new Point(60,180); pointList.add(p3); Point p4 = new Point(260,180);
         * pointList.add(p4); Point p5 = new Point(460,380); pointList.add(p5);
         * String srcImagePath = "D:/test/fileSource/004.jpg"; int width = 10; int
         * height = 10; Color ovalColor = Color.RED; String imageFormat = "jpg";
         * String toPath = "D:/test/desk/points-004.jpg";
         * imageObj.drawPoints(srcImagePath, pointList, width, height, ovalColor,
         * imageFormat, toPath);//画出一组（多个）点
         */
         ...
         * imageObj.drawPolylineShowPoints(srcImagePath, xPoints, yPoints, nPoints,
         * lineColor, width, height, ovalColor, toPath, imageFormat);//画折线并突出显示点
         */

        /*
         * String srcImagePath ="D:/test/fileSource/004.jpg"; int[] xPoints
         * ={50,90,180,320,640}; int[] yPoints ={200,300,120,240,360}; int nPoints =
         * 5; Color polygonColor = Color.PINK; float alpha = (float) 0.2; String
         * imageFormat ="jpg"; String toPath ="D:/test/desk/drawalpha-004.jpg";
         ...
         * "D:/test/fileSource/001.jpg"; long start = System.currentTimeMillis();
         * for(int i=0;i<1000;i++){ Random rand = new Random(); int x =
         * rand.nextInt(1024); int y = rand.nextInt(768);
         * imageObj.mergeBothImage(negativeImagePath, additionImagePath, x, y,
        ...
        // 叠加组合图像
        /*
         * String negativeImagePath = "D:/test/fileSource/001.jpg"; String toPath =
         * "D:/test/fileSource/001.jpg"; String additionImagePath =
         * "D:/test/fileSource/007.png"; List additionImageList = new ArrayList();
         * int count = 0; for(int i=0;i<100;i++){//为什么总是连续生成一样的随机数？？？ Random rand =
         * new Random(); int x = rand.nextInt(1020); String xStr = x+""; int y =
         * rand.nextInt(760); String yStr = y +""; String[] str =
         * {xStr,yStr,additionImagePath}; additionImageList.add(str); count++;
         * //System.out.println(xStr+"   :     "+yStr); } System.out.println(count);
         ...
         * "D:/test/desk/16a_v2.jpg"; String toPath3 = "D:/test/desk/16a_v3.jpg";
         * String toPath4 = "D:/test/desk/16a_v4.jpg"; String toPath5 =
         * "D:/test/desk/16a_v5.jpg"; String toPath6 = "D:/test/desk/16a_v6.jpg";
         * 
         ...
         * 
         * imageObj.joinImageListHorizontal(pics7, imageFormat, toPath7); long end =
