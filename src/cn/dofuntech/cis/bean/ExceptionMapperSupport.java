...
import cn.dofuntech.core.exception.BaseException;
import cn.dofuntech.core.exception.DaoException;
import cn.dofuntech.core.exception.ServiceException;
...
public class ExceptionMapperSupport implements ExceptionMapper<Exception> {
    ...
    public Response toResponse(Exception exception) {
        ...
        if (exception instanceof BaseException) {
            ...
            message = context.getMessage(code, args, daoException.getMessage(), request.getLocale());
        }
        else if (exception instanceof ServiceException) {
            ServiceException serviceException = (ServiceException) exception;
            String code = serviceException.getCode();
            Object[] args = serviceException.getValues();
            message = context.getMessage(code, args, serviceException.getMessage(), request.getLocale());
        }
