...
import cn.dofuntech.mina.server.socket.Base64.OutputStream;
...
public class QrCodeUtil {
 private static final String CHARSET     = "utf-8";
	     ...
	     * @throws Exception 
	     */
	    public static void encode(String content,String referralCode) {
	        try {
	            ...
	            ImageIO.write(image, FORMAT_NAME, new File(path,referralCode+".jpg"));  
	        }
	        catch (Exception e) {
	            e.printStackTrace();
	        }
...
//	            int y = (big.getHeight() - small.getHeight()) / 2;  
	            int y = 615;  
	            g.drawImage(small, x, y, 206, 206, null);  
	            g.dispose();  
