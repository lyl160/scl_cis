...
//		userMap = new HashMap<Integer,HttpSession>();
...
//	}
     ...
     * @return
     */
	public static Map<Integer, HttpSession> getUserMap() {
		return userMap;
	}
	/**
	 * 保存SESSION信息
	 ...
	 * @param session
	 */
	public static void setUserSession(Integer id,HttpSession session){
		/*
