...
import cn.dofuntech.dfauth.controller.RoleController;
import cn.dofuntech.dfauth.repository.mapper.MenuDao;
import cn.dofuntech.dfauth.repository.mapper.RoleDao;
...
//		con.put("roleId", roleInf.getRoleId());
		...
		if (resultCount > 0) {
			throw new Exception("该机构下改角色名已存在");
		}
		try {
...
//		checkValue = menuGetParent(checkValue);
	...
	public List<RoleInf> getRoleInfByUser(Integer uid) {
		return roleDao.selectRoleInfByUser(uid);
	}

	public void checkRoleStateByUserId(Integer uid) throws Exception {
		// TODO Auto-generated method stub
